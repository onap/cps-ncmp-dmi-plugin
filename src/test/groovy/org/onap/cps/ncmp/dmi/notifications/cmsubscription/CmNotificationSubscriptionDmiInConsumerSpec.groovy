...
@SpringBootTest(classes = [CmNotificationSubscriptionDmiInConsumer])
@Testcontainers
@DirtiesContext
class CmNotificationSubscriptionDmiInConsumerSpec extends MessagingBaseSpec {
    def objectMapper = new ObjectMapper()
    def testTopic = 'dmi-ncmp-cm-avc-subscription'

    @SpringBean
    CmNotificationSubscriptionDmiInConsumer objectUnderTest = new CmNotificationSubscriptionDmiInConsumer(cloudEventKafkaTemplate)
    ...
    def 'Sends subscription cloud event response successfully.'() {
        given: 'an subscription event response'
            ...
            def cmSubscriptionDmiOutEventData = new Data(statusCode: '1', statusMessage: 'Success')
        ...
        when: 'an event is published'
            ...
            objectUnderTest.createAndSendCmNotificationSubscriptionDmiOutEvent(eventKey, "subscriptionCreatedStatus", correlationId)
        and: 'topic is polled'
