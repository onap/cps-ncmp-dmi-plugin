...
@SpringBootTest(classes = [AvcEventProducer])
@Testcontainers
@DirtiesContext
class AvcEventExecutorIntegrationSpec extends MessagingBaseSpec {
    ...
    def dmiService =  new DmiRestController(
            ...
            Mock(AsyncTaskExecutor), avcEventProducer)
