...
class DmiRestControllerSpec extends Specification {
    ...
    @SpringBean
    CpsAsyncRequestResponseEventProducer cpsAsyncRequestResponseEventProducer = new CpsAsyncRequestResponseEventProducer(Mock(KafkaTemplate), "my-topic-999")

    @SpringBean
    CpsAsyncRequestResponseEventProducerService mockCpsAsyncRequestResponseEventProducerService = new CpsAsyncRequestResponseEventProducerService(cpsAsyncRequestResponseEventProducer)
