...
class DmiServiceImplSpec extends Specification {
    ...
    def 'Get a single module resource.'() {
        ...
        and: 'the result is a sdnc response that contains the name and revision and is wrapped inside an array'
    ...
    def 'Get multiple module resources.'() {
        ...
        and: 'the response is the name, revision and list of all module resource schemas returned by sdnc'
