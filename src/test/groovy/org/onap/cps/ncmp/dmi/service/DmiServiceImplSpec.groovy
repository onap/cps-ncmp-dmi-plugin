...
class DmiServiceImplSpec extends Specification {
    ...
    def 'Get module resources with JSON processing exception.'() {
        given: 'get module schema is invoked and returns a response from sdnc'
            mockSdncOperations.getModuleResource(_ as String, _ as String) >> new ResponseEntity<String>('{"ietf-netconf-monitoring:output": {"data": "some-data1"}}', HttpStatus.OK)
        and: 'a json processing exception during conversion'
