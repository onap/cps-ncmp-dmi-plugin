...
package org.onap.cps.dmi.clients;
...
public class NcmpRestClient {
    ...
    private static final String DMI_REGISTRATION_PATH = "cps-ncmp/api/ncmp-dmi/v1/ch";
    ...
    public ResponseEntity<String> registerCmHandlesWithNcmp(final String jsonData) {
        ...
        final var responseEntity =
            restTemplate.exchange(ncmpRegistrationUrl, HttpMethod.POST, httpEntity, String.class);
