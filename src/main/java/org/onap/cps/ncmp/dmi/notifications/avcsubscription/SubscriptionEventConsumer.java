...
public class SubscriptionEventConsumer {
    ...
    public void consumeSubscriptionEvent(final ConsumerRecord<String, CloudEvent> subscriptionCloudEvent) {
        ...
        if (subscriptionEvent != null) {
            ...
            sendSubscriptionResponseMessage(eventKey, subscriptionType,
    ...
    public void sendSubscriptionResponseMessage(final String eventKey,
        ...
        cloudEventKafkaTemplate.send(cmAvcSubscriptionResponseTopic, eventKey,
            SubscriptionEventResponseMapper.toCloudEvent(subscriptionEventResponse,
                eventKey, subscriptionType, dmiName));
    }
    ...
    private SubscriptionEventResponse formSubscriptionEventResponse(final SubscriptionEvent subscriptionEvent) {
        ...
        final List<CmHandle> cmHandleIdToCmHandlePropertyMap = subscriptionEvent.getData()
    ...
    private Set<String> extractCmHandleIds(final List<CmHandle> cmHandleIdTocmHandlePropertyMap) {
        final Set<String> cmHandleIds = new HashSet<>();

        for (final CmHandle cmHandle : cmHandleIdTocmHandlePropertyMap) {
