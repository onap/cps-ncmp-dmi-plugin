...
public class AsyncTaskExecutor {
    ...
    protected void publishAsyncEvent(final String topicName,
                                     final String requestId,
    ...
    protected void publishAsyncFailureEvent(final String topicName,
        ...
        String code = HttpStatus.INTERNAL_SERVER_ERROR.toString().substring(0, 3);
        ...
        if (throwable instanceof HttpClientRequestException) {
            ...
            code = String.valueOf(httpClientRequestException.getHttpStatus().value()).substring(0, 3);
        }
