...
public class AsyncTaskExecutor {
    ...
    public static final Pattern RESPONSE_STATUS_PATTERN = Pattern.compile("(\\d{3})(\\W\\b[A-Z].*?\\b)+");
    ...
    protected void publishAsyncFailureEvent(final String topicName,
        ...
        final Matcher responseStatusMatcher = RESPONSE_STATUS_PATTERN.matcher(throwable.getMessage());
