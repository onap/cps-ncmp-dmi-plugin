...
public class DmiExceptionHandler {
    ...
    @ExceptionHandler({CmHandleRegistrationException.class})
    public static ResponseEntity<Object> handleCmHandleRegistrationException(final DmiException exception) {
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, exception);
    }
