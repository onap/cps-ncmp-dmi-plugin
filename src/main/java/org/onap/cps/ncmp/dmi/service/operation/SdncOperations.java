...
public class SdncOperations {
    ...
    public static final int QUERY_PARAM_SPLIT_LIMIT = 2;
    public static final int QUERY_PARAM_VALUE_INDEX = 1;
    public static final int QUERY_PARAM_NAME_INDEX = 0;
    public static final int QUERY_PARAM_LENGTH_ONE = 1;
    ...
    private MultiValueMap<String, String> getQueryParamsAsMap(final String optionsParamInQuery,
        ...
        if (!StringUtils.isEmpty(optionsParamInQuery)) {
            ...
            queryParams.setAll(
                    Arrays.stream(splitTempQueryByComma)
                            .map(queryParamPair -> {
                            ...
                            .collect(Collectors.toMap(
                                    queryParam -> queryParam[QUERY_PARAM_NAME_INDEX], // Add query key at first place
                                    queryParam -> queryParam.length > QUERY_PARAM_LENGTH_ONE
                                            ? queryParam[QUERY_PARAM_VALUE_INDEX] // Add query value at second place
                                            : StringUtils.EMPTY)));
        }
        return queryParams;
    }
