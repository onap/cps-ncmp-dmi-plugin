...
public class SdncOperations {
     ...
     */
    public ResponseEntity<String> getModuleSchema(final String nodeId, final String moduleProperties) {
    ...
    private String prepareGetSchemaUrl(final String nodeId) {
        final String topologyUrl =
            TOPOLOGY_URL_TEMPLATE_DATA.replace("{topologyId}", this.sdncProperties.getTopologyId());
        final var topologyMountUrl = topologyUrl + MOUNT_URL_TEMPLATE;
