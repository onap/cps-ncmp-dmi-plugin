...
import org.onap.cps.ncmp.dmi.service.model.StandardDefinedFieldsData;
...
public class DmiAsyncConsumerVesToAvcEventCreator {
    ...
    public AvcEvent createEventFromVes(final String msg) throws JsonProcessingException {
        ...
        editarrayObject.put("operation", data.getMoiChanges().getOperation());
        ...
        editarrayObject.put("value", data.getMoiChanges().getValue());
