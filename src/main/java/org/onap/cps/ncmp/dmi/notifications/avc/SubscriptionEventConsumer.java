...
public class SubscriptionEventConsumer {
     ...
     *
     * @param subscriptionEventResponse the event response to publish
     */
    public void sendSubscriptionEventMessage(final SubscriptionEventResponse subscriptionEventResponse) {
    ...
    public void consumeSubscriptionEvent(final SubscriptionEvent subscriptionEvent) {
        ...
        subscriptionEventResponse.setStatus(SubscriptionEventResponseStatus.ACCEPT.getResponseStatus());
        sendSubscriptionEventMessage(subscriptionEventResponse);
    }
}
