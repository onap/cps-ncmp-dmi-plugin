...
public class SubscriptionEventConsumer {
    ...
    public void consumeSubscriptionEvent(@Payload final SubscriptionEvent subscriptionEvent,
        ...
        log.info("Subscription for SubscriptionName {} is received at {} by dmi plugin.", subscriptionName,
                dateAndTimeReceived);
        sendSubscriptionResponseMessage(eventKey, formSubscriptionEventResponse(subscriptionEvent, eventKey));
    }
    ...
    private SubscriptionEventResponse formSubscriptionEventResponse(final SubscriptionEvent subscriptionEvent,
        ...
        subscriptionEventResponse.setDmiName(extractDmiNameFromEventKey(eventKey));
    ...
    private String extractDmiNameFromEventKey(final String eventKey) {
        final String[] eventKeySplit = eventKey.split("-");
        log.info("Event key array after split {}", Arrays.toString(eventKeySplit));
        return eventKeySplit[eventKeySplit.length - 1];
    }
