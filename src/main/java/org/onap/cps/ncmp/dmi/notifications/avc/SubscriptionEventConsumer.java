...
public class SubscriptionEventConsumer {
    ...
    public void consumeSubscriptionEvent(final SubscriptionEvent subscriptionEvent) {
        ...
        final List<Map<String, Map<String, Map<String, String>>>> cmHandles =
                (List<Map<String, Map<String, Map<String, String>>>>) subscriptionEvent.getEvent()
                .getPredicates()
                .get("targets");
        ...
        subscriptionEventResponse.setCmHandles(cmHandles);

        sendSubscriptionResponseMessage(subscriptionEventResponse);
    }
}
