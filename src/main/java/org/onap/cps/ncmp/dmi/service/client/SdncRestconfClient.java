...
public class SdncRestconfClient {
     ...
     *
     * @param getOperationUrl sdnc get url
     * @param acceptMediaType acceptable media type in response
     *
     * @return the response entity
     */
    public ResponseEntity<String> getOperation(final String getOperationUrl, final String acceptMediaType) {
        final StringBuilder sdncBaseUrl = new StringBuilder(sdncProperties.getBaseUrl());
        sdncBaseUrl.append(getOperationUrl);
        ...
        return restTemplate.exchange(sdncBaseUrl.toString(), HttpMethod.GET, httpEntity, String.class);
    }
}
