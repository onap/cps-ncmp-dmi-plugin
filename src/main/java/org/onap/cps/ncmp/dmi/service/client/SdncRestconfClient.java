...
public class SdncRestconfClient {
     ...
     *
     * @param sdncGetModuleSourceUrl sdnc get module source url
     * @param jsonData                 json data
     * @return the response entity
     */
    public ResponseEntity<String> postOperationWithJsonData(final String sdncGetModuleSourceUrl,
        final String jsonData) {
        final var sdncBaseUrl = sdncProperties.getBaseUrl();
        final var sdncRestconfUrl = sdncBaseUrl.concat(sdncGetModuleSourceUrl);
        final var httpHeaders = new HttpHeaders();
        httpHeaders.setBasicAuth(sdncProperties.getAuthUsername(), sdncProperties.getAuthPassword());
