...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
    ...
    public ResponseEntity<Object> dataAccessPassthroughOperational(final String resourceIdentifier,
        ...
        if (hasTopic(topicParamInQuery)) {
            ...
            log.debug("Result completed {}", result.isDone());
            return ResponseEntity.ok("Async Request Recieved");
        }
    ...
    private String getPassthroughOperationalSdncResponse(final DataAccessRequest dataAccessRequest,
                                                         ...
                                                         final String resourceIdentifier,
                                                         final String optionsParamInQuery) {
        return dmiService.getResourceData(cmHandle, resourceIdentifier,
                optionsParamInQuery, RESTCONF_CONTENT_PASSTHROUGH_OPERATIONAL_QUERY_PARAM);
    }
