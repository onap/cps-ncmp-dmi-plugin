...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
    ...
    public ResponseEntity<YangResources> retrieveModuleResources(
        ...
        final List<ModuleReference> moduleReferenceList = convertRestObjectToJavaApiObject(moduleResourcesReadRequest);
        final YangResources response = dmiService.getModuleResources(cmHandle, moduleReferenceList);
