...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
     ...
     *
     * @param passthroughRequest pass through request
     * @param cmHandle cmHandle
     * @param resourceIdentifier resource identifier
     * @return (@ code ResponseEntity) response entity
     */
    @Override
    public ResponseEntity<Object> writeDataByPassthroughRunningForCmHandle(final DataAccessRequest passthroughRequest,
