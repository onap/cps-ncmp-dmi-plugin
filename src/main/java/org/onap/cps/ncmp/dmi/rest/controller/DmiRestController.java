...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
    ...
    @Override
    public ResponseEntity<Object> retrieveModuleReources(final ModuleResources moduleResources, final String cmHandle) {
        final var modulesData = convertRestObjectToJavaApiObject(moduleResources);
    ...
    private Modules convertRestObjectToJavaApiObject(final ModuleResources moduleResources) {
        return objectMapper.convertValue(moduleResources.getData(), Modules.class);
    }
}
