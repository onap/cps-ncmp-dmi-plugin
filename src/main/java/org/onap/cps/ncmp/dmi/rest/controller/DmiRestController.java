...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
    ...
    /**
     * This method fetches the resource for given cm handle using pass through operational datastore. It filters the response on
    ...
    /**
     * This method fetches the resource for given cm handle using pass through running datastore. It filters the response on
