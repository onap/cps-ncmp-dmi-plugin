...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
    ...
    @Override
    public ResponseEntity<Object> retrieveModuleResources(
            final @Valid DmiModuleSchemaReadRequestBody dmiModuleSchemaReadRequestBody,
    ...
    private List<ModuleReference> convertRestObjectToJavaApiObject(
            final DmiModuleSchemaReadRequestBody dmiModuleSchemaReadRequestBody) {
        return objectMapper
