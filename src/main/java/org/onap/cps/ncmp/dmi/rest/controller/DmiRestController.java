...
public class DmiRestController implements DmiPluginApi, DmiPluginInternalApi {
     ...
     *
     * @param requestId              requestId generated by NCMP once the request received
     * @param topic                  Kafka topic name
     * @param batchDataRequestBody   Which has list of cmhandles, datastore along with other attributes
     * @return (@ code ResponseEntity) response entity
     */
    @Override
    public ResponseEntity<Object> getResourceDataByCmHandles(final String requestId, final String topic,
            final Object batchDataRequestBody) {
        log.info("Batch data request received: {}", batchDataRequestBody);
