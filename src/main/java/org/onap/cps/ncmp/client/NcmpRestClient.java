...
public class NcmpRestClient {
    ...
    public ResponseEntity<String> registerCmHandlesWithNcmp(final String jsonData) {
        final var cpsNcmpRegistrationUrl = buildCpsNcmpRegistrationUrl();
        ...
        final var responseEntity =
            restTemplate.exchange(cpsNcmpRegistrationUrl, HttpMethod.POST, httpEntity, String.class);
        return responseEntity;
    }

    private String buildCpsNcmpRegistrationUrl() {
        return UriComponentsBuilder
            .fromHttpUrl(cpsConfiguration.getBaseUrl())
            .path("cps-ncmp/api/ncmp-dmi/v1/ch")
            .toUriString();
    }
}