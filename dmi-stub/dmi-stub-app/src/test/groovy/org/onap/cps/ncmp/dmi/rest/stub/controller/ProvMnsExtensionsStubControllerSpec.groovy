...
@WebMvcTest([ProvMnSExtensionsStubController, ControllerSimulation])
class ProvMnsExtensionsStubControllerSpec extends Specification {
    ...
    def 'ProvMnS Extensions POST request with #scenario.'() {
        given: 'the provmns extensions url'
            def url = "/prov-mns-extensions/v1alpha1/actions/someSegment=1/otherSegment=2/${segmentName}=${segmentValue}/finalSegment"
        when: 'post actions request is executed'
        ...
        where: 'following simulations are applied'
            ...
            'no simulation' | 'anotherSegment' | 'some value'     || HttpStatus.OK            || '"KeySetByStub":"ValueSetByStub"'
            'delay 1'       | 'dmiSimulation'  | 'slowResponse_1' || HttpStatus.OK            || '"KeySetByStub":"ValueSetByStub"'
