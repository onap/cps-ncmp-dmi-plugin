...
public class YangModuleFactory {
    ...
    private String createModuleReferencesJson(final int numberOfModules) {
        ...
        for (int i = 0; i < numberOfModules; i++) {
            moduleReferencesList.add(new ModuleReference("module" + i, generateModuleRevision(i)));
        }
    ...
    private String createModuleResourcesJson(final int numberOfModules) {
        ...
        for (int i = 0; i < numberOfModules; i++) {
            ...
            final String revision = generateModuleRevision(i);
    ...
    private String generateModuleRevision(final int index) {
        return LocalDate.of(2021, 1, 1).plusDays(index) + "-" + DEFAULT_TAG;
    }
