...
public class YangModuleFactory {
    ...
    private String createModuleReferencesJson(final String tag, final int numberOfModules) {
        ...
        final int tagIndex = MODULE_SET_TAGS.indexOf(tag);
        for (int i = 0; i < numberOfModules; i++) {
            moduleReferencesList.add(new ModuleReference("module" + i, generateModuleRevision(tagIndex)));
        }
    ...
    private String createModuleResourcesJson(final String tag, final int numberOfModules) {
        ...
        for (int i = 0; i < numberOfModules; i++) {
            ...
            final String revision = generateModuleRevision(tagIndex);
    ...
    private String generateModuleRevision(final int tagIndex) {
