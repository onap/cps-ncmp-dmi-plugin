...
public class LcmEventConsumer {
    ...
    /**
     * Consume the LCM event to enable the data synchronization for the ready devices.
     *
     * @param lcmEvent Lifecycle event of a cm handle identifier
     */
    ...
    public void consumeLcmEvent(final LcmEvent lcmEvent) {
        ...
        if (newValues.getCmHandleState() == Values.CmHandleState.READY) {
            ...
            dmiService.enableDataSyncForCmHandles(List.of(cmHandleId));
        }
    }
