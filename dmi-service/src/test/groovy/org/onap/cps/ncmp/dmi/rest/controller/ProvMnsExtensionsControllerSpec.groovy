...
class ProvMnsExtensionsControllerSpec extends Specification {
    ...
    def 'Execute action from provmns extensions interface.'() {
        given: 'actions url'
            def provMnSExtensionsUrl = "$provMnSExtensionsBasePath/v1alpha1/actions/some=fdn/updateAction"
        when: 'post action request is performed'
