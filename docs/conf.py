...
rst_epilog = f"""
.. |dmi_openapi_url| replace:: https://gerrit.onap.org/r/gitweb?p=cps.git;a=blob_plain;f=docs/api/swagger/dmi/openapi.yml;hb=refs/heads/{release}
.. |dmi_openapi_datajob_url| replace:: https://gerrit.onap.org/r/gitweb?p=cps.git;a=blob_plain;f=docs/api/swagger/dmi/openapi-datajob.yml;hb=refs/heads/{release}
"""
