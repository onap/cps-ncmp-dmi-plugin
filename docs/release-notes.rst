...
--------
    ...
    - `CPS-3186 <https://lf-onap.atlassian.net/browse/CPS-3186>`_  Improved Security Updates

Limitations
-----------
    - ProvMnS and ProvMnS Actions interface not implemented
...
|                                      |                                                        |
+--------------------------------------+--------------------------------------------------------+
| **Docker images**                    | onap/ncmp-dmi-plugin:1.7.1                             |
|                                      |                                                        |
+--------------------------------------+--------------------------------------------------------+
